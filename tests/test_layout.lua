...
local function test_example_application_xml()
	...
	local icon_card_title_binding = icon_card:find('Text="{../../Card.Title}"', 1, true)
	local icon_card_uses_deep_icon_binding = icon_card:find('Source="{../../../Card.Icon}"', 1, true)
	...
	local icon_card_badge_uses_title_depth = icon_card:find('BackgroundColor="{../../Card.IconBackground}"', 1, true)
