...
local function test_example_application_xml()
	...
	local icon_violet = package_lua:find('Key = "icon-violet"', 1, true)
	local icon_blue = package_lua:find('Key = "icon-blue"', 1, true)
	local icon_green = package_lua:find('Key = "icon-green"', 1, true)
	local icon_amber = package_lua:find('Key = "icon-amber"', 1, true)
	local icon_sky = package_lua:find('Key = "icon-sky"', 1, true)
	local icon_rose = package_lua:find('Key = "icon-rose"', 1, true)
	...
	test.expect(icon_violet ~= nil, "Example package.lua should define icon-violet")
	test.expect(icon_blue ~= nil, "Example package.lua should define icon-blue")
	test.expect(icon_green ~= nil, "Example package.lua should define icon-green")
	test.expect(icon_amber ~= nil, "Example package.lua should define icon-amber")
	test.expect(icon_sky ~= nil, "Example package.lua should define icon-sky")
	test.expect(icon_rose ~= nil, "Example package.lua should define icon-rose")
