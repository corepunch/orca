...
local function test_example_application_xml()
	...
	local hero_columns_expr = xml:find('<ExpressionBinding Target="Grid.Columns">IF(STEP(640, {../../../Node.ActualWidth}), "auto auto", "auto")</ExpressionBinding>', 1, true)
	local body_padding_expr = xml:find('<ExpressionBinding Target="Node.HorizontalPadding">IF(STEP(640, {../../Node.ActualWidth}), Vector2(40,40), Vector2(8,8))</ExpressionBinding>', 1, true)
	...
	test.expect(hero_columns_expr ~= nil, "Application.xml should use explicit <ExpressionBinding Target=\"...\"> for Hero Grid.Columns")
	test.expect(body_padding_expr ~= nil, "Application.xml should use explicit <ExpressionBinding Target=\"...\"> for body horizontal padding")
