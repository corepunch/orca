...
ORCA_API lpcString_t __strtoBorderRadiusShorthand(lpcString_t str, lpBorderRadiusShorthand_t output) {
	...
	str = __strtofloat(str, &output->TopRightRadius);
	str = __strtofloat(str, &output->BottomRightRadius);
...
ORCA_API lpcString_t __strtoFontShorthand(lpcString_t str, lpFontShorthand_t output) {
	...
	lpcString_t __strtofloat(lpcString_t, float*);
	str = __strtoFontWeight(str, &output->Weight);
	str = __strtoFontStyle(str, &output->Style);
...
ORCA_API lpcString_t __strtoShadowShorthand(lpcString_t str, lpShadowShorthand_t output) {
	...
	str = __strtovec2(str, &output->Offset);
	str = __strtofloat(str, &output->BlurRadius);
	str = __strtofloat(str, &output->SpreadRadius);
	str = __strtocolor(str, &output->Color);
	return str;
}
...
ORCA_API lpcString_t __strtoRingShorthand(lpcString_t str, lpRingShorthand_t output) {
	lpcString_t __strtocolor(lpcString_t, struct color*);
	lpcString_t __strtofloat(lpcString_t, float*);
	str = __strtofloat(str, &output->Offset);
	str = __strtofloat(str, &output->Width);
	str = __strtocolor(str, &output->Color);
	return str;
}
...
ORCA_API lpcString_t __strtoSizeAxisShorthand(lpcString_t str, lpSizeAxisShorthand_t output) {
	...
	str = __strtofloat(str, &output->Desired);
	str = __strtofloat(str, &output->Min);
	str = __strtofloat(str, &output->Actual);
...
static struct PropertyType const NodeProperties[kNodeNumProperties] = {
	...
	Node, "Size", Size, kDataTypeStruct, .TypeString="SizeShorthand"),
	/* Node.HorizontalSize */ DECL(0x2dbf56d8, 0x8dd5feec,
	Node, "HorizontalSize", Size.Axis[0], kDataTypeStruct, .TypeString="SizeAxisShorthand"),
	...
	Node, "VerticalSize", Size.Axis[1], kDataTypeStruct, .TypeString="SizeAxisShorthand"),
	...
	Node, "DepthSize", Size.Axis[2], kDataTypeStruct, .TypeString="SizeAxisShorthand"),
	...
	Node, "Margin", Margin, kDataTypeStruct, .TypeString="MarginShorthand"),
	/* Node.HorizontalMargin */ DECL(0x1d32e627, 0xe4abc3eb,
	Node, "HorizontalMargin", Margin.Axis[0], kDataTypeStruct, .TypeString="EdgeShorthand"),
	...
	Node, "VerticalMargin", Margin.Axis[1], kDataTypeStruct, .TypeString="EdgeShorthand"),
	...
	Node, "DepthMargin", Margin.Axis[2], kDataTypeStruct, .TypeString="EdgeShorthand"),
	...
	Node, "Padding", Padding, kDataTypeStruct, .TypeString="MarginShorthand"),
	/* Node.HorizontalPadding */ DECL(0x96255a02, 0x18bd87c6,
	Node, "HorizontalPadding", Padding.Axis[0], kDataTypeStruct, .TypeString="EdgeShorthand"),
	...
	Node, "VerticalPadding", Padding.Axis[1], kDataTypeStruct, .TypeString="EdgeShorthand"),
	...
	Node, "DepthPadding", Padding.Axis[2], kDataTypeStruct, .TypeString="EdgeShorthand"),
...
static struct PropertyType const TextRunProperties[kTextRunNumProperties] = {
	...
	TextRun, "Font", Font, kDataTypeStruct, .TypeString="FontShorthand"),
	...
	TextRun, "Underline", Underline, kDataTypeStruct, .TypeString="UnderlineShorthand"),
...
static struct PropertyType const TextBlockConceptProperties[kTextBlockConceptNumProperties] = {
	...
	TextBlockConcept, "Placeholder", Placeholder, kDataTypeStruct, .TypeString="BrushShorthand"),
...
static struct PropertyType const Node2DProperties[kNode2DNumProperties] = {
	...
	Node2D, "Background", Background, kDataTypeStruct, .TypeString="BrushShorthand"),
	...
	Node2D, "Foreground", Foreground, kDataTypeStruct, .TypeString="BrushShorthand"),
	...
	Node2D, "BoxShadow", BoxShadow, kDataTypeStruct, .TypeString="ShadowShorthand"),
	...
	Node2D, "Overflow", Overflow, kDataTypeStruct, .TypeString="OverflowShorthand"),
	...
	Node2D, "Ring", Ring, kDataTypeStruct, .TypeString="RingShorthand"),
...
ORCA_API lpcString_t __strtoNavigateToPageArguments(lpcString_t str, lpNavigateToPageArguments_t output) {
	...
	str = __strtofixed(str, &output->URL);
