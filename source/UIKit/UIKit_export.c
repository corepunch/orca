...
LRESULT TriggerProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventPropertyChanged: return Trigger_PropertyChanged(object, cmp, wparm, lparm); // PropertyChanged			case kEventAttached: return Trigger_Attached(object, cmp, wparm, lparm); // Attached		}
	return FALSE;
}
...
LRESULT NodeProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventThemeChanged: return Node_ThemeChanged(object, cmp, wparm, lparm); // ThemeChanged			case kEventGetSize: return Node_GetSize(object, cmp, wparm, lparm); // GetSize			case kEventIsVisible: return Node_IsVisible(object, cmp, wparm, lparm); // IsVisible		}
	return FALSE;
}
...
LRESULT TextBlockConceptProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventCreate: return TextBlockConcept_Create(object, cmp, wparm, lparm); // Create			case kEventDestroy: return TextBlockConcept_Destroy(object, cmp, wparm, lparm); // Destroy			case kEventMakeText: return TextBlockConcept_MakeText(object, cmp, wparm, lparm); // MakeText		}
	return FALSE;
}
...
LRESULT Node2DProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventUpdateMatrix: return Node2D_UpdateMatrix(object, cmp, wparm, lparm); // UpdateMatrix			case kEventCreate: return Node2D_Create(object, cmp, wparm, lparm); // Create			case kEventDestroy: return Node2D_Destroy(object, cmp, wparm, lparm); // Destroy			case kEventUpdateGeometry: return Node2D_UpdateGeometry(object, cmp, wparm, lparm); // UpdateGeometry			case kEventDrawBrush: return Node2D_DrawBrush(object, cmp, wparm, lparm); // DrawBrush			case kEventHandleMessage: return Node2D_HandleMessage(object, cmp, wparm, lparm); // HandleMessage			case kEventScrollWheel: return Node2D_ScrollWheel(object, cmp, wparm, lparm); // ScrollWheel			case kEventMouseMoved: return Node2D_MouseMoved(object, cmp, wparm, lparm); // MouseMoved			case kEventHitTest: return Node2D_HitTest(object, cmp, wparm, lparm); // HitTest			case kEventMeasure: return Node2D_Measure(object, cmp, wparm, lparm); // Measure			case kEventArrange: return Node2D_Arrange(object, cmp, wparm, lparm); // Arrange			case kEventMeasureOverride: return Node2D_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride			case kEventArrangeOverride: return Node2D_ArrangeOverride(object, cmp, wparm, lparm); // ArrangeOverride		}
	return FALSE;
}
...
LRESULT TextBlockProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventMeasureOverride: return TextBlock_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride			case kEventForegroundContent: return TextBlock_ForegroundContent(object, cmp, wparm, lparm); // ForegroundContent			case kEventUpdateGeometry: return TextBlock_UpdateGeometry(object, cmp, wparm, lparm); // UpdateGeometry			case kEventCreate: return TextBlock_Create(object, cmp, wparm, lparm); // Create			case kEventDrawBrush: return TextBlock_DrawBrush(object, cmp, wparm, lparm); // DrawBrush		}
	return FALSE;
}
...
LRESULT InputProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventCreate: return Input_Create(object, cmp, wparm, lparm); // Create			case kEventDrawBrush: return Input_DrawBrush(object, cmp, wparm, lparm); // DrawBrush			case kEventMakeText: return Input_MakeText(object, cmp, wparm, lparm); // MakeText			case kEventKeyDown: return Input_KeyDown(object, cmp, wparm, lparm); // KeyDown			case kEventKillFocus: return Input_KillFocus(object, cmp, wparm, lparm); // KillFocus			case kEventLeftMouseUp: return Input_LeftMouseUp(object, cmp, wparm, lparm); // LeftMouseUp			case kEventMeasureOverride: return Input_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride		}
	return FALSE;
}
...
LRESULT ButtonProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventCreate: return Button_Create(object, cmp, wparm, lparm); // Create			case kEventLeftMouseUp: return Button_LeftMouseUp(object, cmp, wparm, lparm); // LeftMouseUp			case kEventKeyDown: return Button_KeyDown(object, cmp, wparm, lparm); // KeyDown			case kEventDrawBrush: return Button_DrawBrush(object, cmp, wparm, lparm); // DrawBrush		}
	return FALSE;
}
...
LRESULT StackViewProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventMeasureOverride: return StackView_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride			case kEventArrangeOverride: return StackView_ArrangeOverride(object, cmp, wparm, lparm); // ArrangeOverride		}
	return FALSE;
}
...
LRESULT FormProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventCreate: return Form_Create(object, cmp, wparm, lparm); // Create			case kEventSubmit: return Form_Submit(object, cmp, wparm, lparm); // Submit		}
	return FALSE;
}
...
LRESULT ScreenProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventRenderScreen: return Screen_RenderScreen(object, cmp, wparm, lparm); // RenderScreen			case kEventMeasureOverride: return Screen_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride			case kEventCreate: return Screen_Create(object, cmp, wparm, lparm); // Create			case kEventDestroy: return Screen_Destroy(object, cmp, wparm, lparm); // Destroy			case kEventWindowResized: return Screen_WindowResized(object, cmp, wparm, lparm); // WindowResized		}
	return FALSE;
}
...
LRESULT GridProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventMeasureOverride: return Grid_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride			case kEventArrangeOverride: return Grid_ArrangeOverride(object, cmp, wparm, lparm); // ArrangeOverride		}
	return FALSE;
}
...
LRESULT ImageViewProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventMeasureOverride: return ImageView_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride			case kEventArrangeOverride: return ImageView_ArrangeOverride(object, cmp, wparm, lparm); // ArrangeOverride			case kEventForegroundContent: return ImageView_ForegroundContent(object, cmp, wparm, lparm); // ForegroundContent			case kEventDrawBrush: return ImageView_DrawBrush(object, cmp, wparm, lparm); // DrawBrush			case kEventLoadView: return ImageView_LoadView(object, cmp, wparm, lparm); // LoadView		}
	return FALSE;
}
...
LRESULT NinePatchImageProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventMeasureOverride: return NinePatchImage_MeasureOverride(object, cmp, wparm, lparm); // MeasureOverride			case kEventForegroundContent: return NinePatchImage_ForegroundContent(object, cmp, wparm, lparm); // ForegroundContent			case kEventDrawBrush: return NinePatchImage_DrawBrush(object, cmp, wparm, lparm); // DrawBrush		}
	return FALSE;
}
...
LRESULT TerminalViewProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventCreate: return TerminalView_Create(object, cmp, wparm, lparm); // Create			case kEventDrawBrush: return TerminalView_DrawBrush(object, cmp, wparm, lparm); // DrawBrush			case kEventPushProperty: return TerminalView_PushProperty(object, cmp, wparm, lparm); // PushProperty			case kEventScrollWheel: return TerminalView_ScrollWheel(object, cmp, wparm, lparm); // ScrollWheel		}
	return FALSE;
}
...
LRESULT PageHostProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
			case kEventViewDidLoad: return PageHost_ViewDidLoad(object, cmp, wparm, lparm); // ViewDidLoad			case kEventNavigateToPage: return PageHost_NavigateToPage(object, cmp, wparm, lparm); // NavigateToPage			case kEventNavigateBack: return PageHost_NavigateBack(object, cmp, wparm, lparm); // NavigateBack		}
	return FALSE;
}
