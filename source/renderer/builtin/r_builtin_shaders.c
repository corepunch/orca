...
struct shader_desc shader_rect = {
  ...
  .Uniforms = {
    ...
    { "u_bboxMin", UT_FLOAT_VEC3, PRECISION_MEDIUM },
    { "u_bboxMax", UT_FLOAT_VEC3, PRECISION_MEDIUM },
    { "u_opacity", UT_FLOAT, PRECISION_LOW },
  },
    .Attributes = {
      { "a_position", UT_FLOAT_VEC4 },
...
struct shader_desc shader_charset= {
  ...
  .Uniforms = {
    ...
    { "u_bboxMax", UT_FLOAT_VEC3, PRECISION_MEDIUM },
    { "u_color", UT_COLOR, PRECISION_LOW },
    { "u_textureSize", UT_FLOAT_VEC2, PRECISION_MEDIUM },
    { "u_selectedItem", UT_FLOAT_VEC2, PRECISION_MEDIUM },
    { "u_cursorPos", UT_FLOAT_VEC2, PRECISION_MEDIUM },
  },
    .Attributes = {
      { "a_position", UT_FLOAT_VEC4 },
      { "a_texcoord0", UT_FLOAT_VEC2 },
  ...
  "  v_texcoord0 = (u_textureTransform * vec3(a_position.x, 1.0 - a_position.y, 1.0)).xy;\n"
  "}\n",
    .FragmentShader =
