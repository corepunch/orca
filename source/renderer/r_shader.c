...
static lpcString_t uniforms[kShaderUniform_Count] = {
  [kShaderUniform_ModelTransform] = "u_modelTransform",
  [kShaderUniform_ModelViewTransform] = "u_modelViewTransform",
  [kShaderUniform_ViewTransform] = "u_viewTransform",
  [kShaderUniform_ProjectionTransform] = "u_projectionTransform",
  [kShaderUniform_ViewProjectionTransform] = "u_viewProjectionTransform",
  [kShaderUniform_NormalTransform] = "u_normalTransform",
  [kShaderUniform_NormalTransform4D] = "u_normalTransform4",
  [kShaderUniform_ModelViewProjectionTransform] = "u_modelViewProjectionTransform",
  [kShaderUniform_TextureTransform] = "u_textureTransform",
  [kShaderUniform_Opacity] = "u_opacity",
  [kShaderUniform_Time] = "u_time",
  [kShaderUniform_Viewport] = "u_viewport",
  [kShaderUniform_CameraPosition] = "u_cameraPosition",
  [kShaderUniform_Texture] = "u_texture",
  [kShaderUniform_TextureSize] = "u_textureSize",
  [kShaderUniform_Color] = "u_color",
  [kShaderUniform_Charset] = "u_charset",
  [kShaderUniform_Palette] = "u_palette",
  [kShaderUniform_CinematicPalette] = "u_cinematicPalette",
  [kShaderUniform_MorphWeights] = "u_morphWeights",
  [kShaderUniform_CursorPosition] = "u_cursorPosition",
  [kShaderUniform_Radius] = "u_radius",
  [kShaderUniform_BorderWidth] = "u_borderWidth",
  [kShaderUniform_BBoxMin] = "u_bboxMin",
  [kShaderUniform_BBoxMax] = "u_bboxMax",
  [kShaderUniform_Lights] = "u_lights",
};

#define VERT_FOFS(x) &((DRAWVERT*)NULL)->x

static struct shader_attr const attributes[VERTEX_SEMANTIC_COUNT] = {
  [VERTEX_SEMANTIC_POSITION] = { "a_position", 3, GL_FLOAT, 0, VERT_FOFS(xyz) },
  [VERTEX_SEMANTIC_NORMAL] = { "a_normal", 3, GL_FLOAT, 0, VERT_FOFS(normal) },
  [VERTEX_SEMANTIC_TANGENT] = { "a_tangent", 3, GL_FLOAT, 0, VERT_FOFS(tangent) },
  [VERTEX_SEMANTIC_BINORMAL] = { "a_binormal", 3, GL_FLOAT, 0, VERT_FOFS(binormal) },
  [VERTEX_SEMANTIC_COLOR] = { "a_color", 4, GL_UNSIGNED_BYTE, 1, VERT_FOFS(color) },
  [VERTEX_SEMANTIC_TEXCOORD0] = { "a_texcoord0", 2, GL_FLOAT, 0, VERT_FOFS(texcoord[0]) },
  [VERTEX_SEMANTIC_TEXCOORD1] = { "a_texcoord1", 2, GL_FLOAT, 0, VERT_FOFS(texcoord[1]) },
#if __EMSCRIPTEN__
  [VERTEX_SEMANTIC_TEXCOORD2] = { "a_texcoord2", 2, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_TEXCOORD3] = { "a_texcoord3", 2, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_TEXCOORD4] = { "a_texcoord4", 2, GL_FLOAT, 0, 0 },
#else
  [VERTEX_SEMANTIC_TEXCOORD2] = { "a_texcoord2", 2, GL_FLOAT, 0, VERT_FOFS(texcoord[2]) },
  [VERTEX_SEMANTIC_TEXCOORD3] = { "a_texcoord3", 2, GL_FLOAT, 0, VERT_FOFS(texcoord[3]) },
  [VERTEX_SEMANTIC_TEXCOORD4] = { "a_texcoord4", 2, GL_FLOAT, 0, VERT_FOFS(texcoord[4]) },
#endif
  [VERTEX_SEMANTIC_WEIGHT] = { "a_weight", 4, GL_FLOAT, 0, VERT_FOFS(weight) },
#if __EMSCRIPTEN__
  [VERTEX_SEMANTIC_MATRIX_INDICES] = { "a_matrix_indices", 4, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH0_POSITION] = { "a_morph0_position", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH1_POSITION] = { "a_morph1_position", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH2_POSITION] = { "a_morph2_position", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH3_POSITION] = { "a_morph3_position", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH0_NORMAL] = { "a_morph0_normal", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH1_NORMAL] = { "a_morph1_normal", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH2_NORMAL] = { "a_morph2_normal", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH3_NORMAL] = { "a_morph3_normal", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH0_TANGENT] = { "a_morph0_tangent", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH1_TANGENT] = { "a_morph1_tangent", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH2_TANGENT] = { "a_morph2_tangent", 3, GL_FLOAT, 0, 0 },
  [VERTEX_SEMANTIC_MORPH3_TANGENT] = { "a_morph3_tangent", 3, GL_FLOAT, 0, 0 },
#else
  [VERTEX_SEMANTIC_MATRIX_INDICES] = { "a_matrix_indices", 4, GL_FLOAT, 0, VERT_FOFS(matrix_indices) },
  [VERTEX_SEMANTIC_MORPH0_POSITION] = { "a_morph0_position", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[0].position) },
  [VERTEX_SEMANTIC_MORPH1_POSITION] = { "a_morph1_position", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[1].position) },
  [VERTEX_SEMANTIC_MORPH2_POSITION] = { "a_morph2_position", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[2].position) },
  [VERTEX_SEMANTIC_MORPH3_POSITION] = { "a_morph3_position", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[3].position) },
  [VERTEX_SEMANTIC_MORPH0_NORMAL] = { "a_morph0_normal", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[0].normal) },
  [VERTEX_SEMANTIC_MORPH1_NORMAL] = { "a_morph1_normal", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[1].normal) },
  [VERTEX_SEMANTIC_MORPH2_NORMAL] = { "a_morph2_normal", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[2].normal) },
  [VERTEX_SEMANTIC_MORPH3_NORMAL] = { "a_morph3_normal", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[3].normal) },
  [VERTEX_SEMANTIC_MORPH0_TANGENT] = { "a_morph0_tangent", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[0].tangent) },
  [VERTEX_SEMANTIC_MORPH1_TANGENT] = { "a_morph1_tangent", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[1].tangent) },
  [VERTEX_SEMANTIC_MORPH2_TANGENT] = { "a_morph2_tangent", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[2].tangent) },
  [VERTEX_SEMANTIC_MORPH3_TANGENT] = { "a_morph3_tangent", 3, GL_FLOAT, 0, VERT_FOFS(morph_target[3].tangent) },
#endif
  [VERTEX_SEMANTIC_USERDATA] = { "a_userdata", 4, GL_UNSIGNED_BYTE, 0, VERT_FOFS(userdata) },
};
...
lpcString_t glsl_precision[] = {
  [PRECISION_NOT_SET] = "",
  [PRECISION_LOW] = "lowp ",
  [PRECISION_MEDIUM] = "mediump ",
  [PRECISION_HIGH] = "highp ",
};
