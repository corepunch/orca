...
// When plugins_luaopen.h is present (generated by `make webgl`), it provides
// forward declarations for every luaopen_orca_* symbol found in the statically
// linked plugin sources and the plugin_modules[] table consumed below.
// Each symbol luaopen_orca_Foo maps to the Lua module "orca.Foo".
#if __has_include("plugins_luaopen.h")
#include "plugins_luaopen.h"
#define HAVE_PLUGINS_LUAOPEN
#endif
