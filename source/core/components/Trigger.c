...
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, LeftButtonDown, "Node.LeftButtonDown")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, RightButtonDown, "Node.RightButtonDown")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, OtherButtonDown, "Node.OtherButtonDown")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, LeftButtonUp, "Node.LeftButtonUp")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, RightButtonUp, "Node.RightButtonUp")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, OtherButtonUp, "Node.OtherButtonUp")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, LeftButtonDragged, "Node.LeftButtonDragged")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, RightButtonDragged, "Node.RightButtonDragged")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, OtherButtonDragged, "Node.OtherButtonDragged")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, LeftDoubleClick, "Node.LeftDoubleClick")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, RightDoubleClick, "Node.RightDoubleClick")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, OtherDoubleClick, "Node.OtherDoubleClick")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, MouseMoved, "Node.MouseMoved")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, ScrollWheel, "Node.ScrollWheel")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, DragDrop, "Node.DragDrop")
EVENT_TRIGGER_MOUSE_HANDLER(OnEventTrigger, DragEnter, "Node.DragEnter")
EVENT_TRIGGER_HANDLER(OnEventTrigger, SetFocus, "Node.SetFocus")
EVENT_TRIGGER_HANDLER(OnEventTrigger, KillFocus, "Node.KillFocus")
EVENT_TRIGGER_HANDLER(OnEventTrigger, KeyDown, "Node.KeyDown")
EVENT_TRIGGER_HANDLER(OnEventTrigger, KeyUp, "Node.KeyUp")
EVENT_TRIGGER_HANDLER(OnEventTrigger, TextInput, "Node.TextInput")
