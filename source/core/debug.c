...
//#else
//  struct color32 c;
//	if (e->message == ID_ScrollWheel && FindClick(tr, e->x, e->y, &c)) {
////		scroll.x += e->dx;
//		scroll.y = MIN(0, scroll.y + e->dy);
//		return TRUE;
//	}
//	bool_t button = e->message == ID_LeftMouseDown
//		|| e->message == ID_RightMouseDown;
...
//      OBJ_SetFlags(object, OBJ_GetFlags(object) | OF_EXPANDED_IN_DEBUG);
//    } else if (e->message == ID_RightMouseDown && GetNode(object)) {
