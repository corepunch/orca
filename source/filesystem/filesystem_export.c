...
void luaX_pushProjectReference(lua_State *L, ProjectReference const* data) {
...
static int f_ProjectReference___call(lua_State *L) {
	return (lua_remove(L, 1), f_new_ProjectReference(L));  // remove ProjectReference from stack and call constructor
}
...
void luaX_pushSystemMessage(lua_State *L, SystemMessage const* data) {
	if (data == NULL) { lua_pushnil(L); return; }
...
static int f_SystemMessage___call(lua_State *L) {
	return (lua_remove(L, 1), f_new_SystemMessage(L));  // remove SystemMessage from stack and call constructor
}
...
void luaX_pushWorkspace(lua_State *L, struct Workspace* Workspace) {
...
void luaX_pushProject(lua_State *L, struct Project* Project) {
...
void luaX_pushLibrary(lua_State *L, struct Library* Library) {
...
void luaX_pushAnimationClipLibrary(lua_State *L, struct AnimationClipLibrary* AnimationClipLibrary) {
...
void luaX_pushScreenLibrary(lua_State *L, struct ScreenLibrary* ScreenLibrary) {
...
void luaX_pushMaterialTypeLibrary(lua_State *L, struct MaterialTypeLibrary* MaterialTypeLibrary) {
...
void luaX_pushMaterialLibrary(lua_State *L, struct MaterialLibrary* MaterialLibrary) {
...
void luaX_pushBrushLibrary(lua_State *L, struct BrushLibrary* BrushLibrary) {
...
void luaX_pushMeshLibrary(lua_State *L, struct MeshLibrary* MeshLibrary) {
...
void luaX_pushTimelineSequenceLibrary(lua_State *L, struct TimelineSequenceLibrary* TimelineSequenceLibrary) {
...
void luaX_pushSceneObjectLibrary(lua_State *L, struct SceneObjectLibrary* SceneObjectLibrary) {
...
void luaX_pushComposerLibrary(lua_State *L, struct ComposerLibrary* ComposerLibrary) {
...
void luaX_pushPipelineItemLibrary(lua_State *L, struct PipelineItemLibrary* PipelineItemLibrary) {
...
void luaX_pushSceneLibrary(lua_State *L, struct SceneLibrary* SceneLibrary) {
...
void luaX_pushTrajectoryLibrary(lua_State *L, struct TrajectoryLibrary* TrajectoryLibrary) {
...
void luaX_pushTransitionLibrary(lua_State *L, struct TransitionLibrary* TransitionLibrary) {
...
void luaX_pushSplineLibrary(lua_State *L, struct SplineLibrary* SplineLibrary) {
...
void luaX_pushPrefabLibrary(lua_State *L, struct PrefabLibrary* PrefabLibrary) {
...
void luaX_pushProfileLibrary(lua_State *L, struct ProfileLibrary* ProfileLibrary) {
...
void luaX_pushEnginePluginLibrary(lua_State *L, struct EnginePluginLibrary* EnginePluginLibrary) {
...
void luaX_pushShortcutLibrary(lua_State *L, struct ShortcutLibrary* ShortcutLibrary) {
...
void luaX_pushLayerLibrary(lua_State *L, struct LayerLibrary* LayerLibrary) {
...
void luaX_pushAnimationLibrary(lua_State *L, struct AnimationLibrary* AnimationLibrary) {
...
void luaX_pushTagLibrary(lua_State *L, struct TagLibrary* TagLibrary) {
...
void luaX_pushThemeLibrary(lua_State *L, struct ThemeLibrary* ThemeLibrary) {
...
void luaX_pushResourceExportTagLibrary(lua_State *L, struct ResourceExportTagLibrary* ResourceExportTagLibrary) {
...
void luaX_pushLocaleLibrary(lua_State *L, struct LocaleLibrary* LocaleLibrary) {
...
void luaX_pushDataSourceLibrary(lua_State *L, struct DataSourceLibrary* DataSourceLibrary) {
...
void luaX_pushPageTransitionCollectionLibrary(lua_State *L, struct PageTransitionCollectionLibrary* PageTransitionCollectionLibrary) {
...
void luaX_pushTextureLibrary(lua_State *L, struct TextureLibrary* TextureLibrary) {
...
void luaX_pushStyleLibrary(lua_State *L, struct StyleLibrary* StyleLibrary) {
...
void luaX_pushStateManagerLibrary(lua_State *L, struct StateManagerLibrary* StateManagerLibrary) {
...
void luaX_pushConnectServiceLibrary(lua_State *L, struct ConnectServiceLibrary* ConnectServiceLibrary) {
...
void luaX_pushConnectUserServiceLibrary(lua_State *L, struct ConnectUserServiceLibrary* ConnectUserServiceLibrary) {
...
void luaX_pushSpriteLibrary(lua_State *L, struct SpriteLibrary* SpriteLibrary) {
...
void luaX_pushSpriteAnimationLibrary(lua_State *L, struct SpriteAnimationLibrary* SpriteAnimationLibrary) {
...
void luaX_pushImageLibrary(lua_State *L, struct ImageLibrary* ImageLibrary) {
...
void luaX_pushFontLibrary(lua_State *L, struct FontLibrary* FontLibrary) {
...
void luaX_pushLocaleReferenceItem(lua_State *L, struct LocaleReferenceItem* LocaleReferenceItem) {
...
void luaX_pushTag(lua_State *L, struct Tag* Tag) {
...
void luaX_pushEnginePlugin(lua_State *L, struct EnginePlugin* EnginePlugin) {
...
void luaX_pushEngineMetaclass(lua_State *L, struct EngineMetaclass* EngineMetaclass) {
...
void luaX_pushThemeGroup(lua_State *L, struct ThemeGroup* ThemeGroup) {
...
void luaX_pushTheme(lua_State *L, struct Theme* Theme) {
...
void luaX_pushEntry(lua_State *L, struct Entry* Entry) {
...
void luaX_pushThemeDefaultValuesDictionary(lua_State *L, struct ThemeDefaultValuesDictionary* ThemeDefaultValuesDictionary) {
