...
/// @brief Wrap layout container that flows children into rows or columns
/** WrapPanel component */
typedef struct WrapPanel WrapPanel_t, *WrapPanelPtr, *lpWrapPanel_t;
typedef struct WrapPanel const *WrapPanelCPtr, *lpcWrapPanel_t;
struct WrapPanel {
