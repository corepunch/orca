// Auto-generated from UIKit.cgen by tools/codegen/plugins/export.c
...
LRESULT PopupProc(struct Object* object, void* cmp, uint32_t message, wParam_t wparm, lParam_t lparm) {
	switch (message) {
		case ID_Popup_ClosePopup: return Popup_ClosePopup(object, cmp, wparm, lparm); // Popup.ClosePopup
	}
	return FALSE;
}
void luaX_pushPopup(lua_State *L, struct Popup const* Popup) {
	luaX_pushObject(L, CMP_GetObject(Popup));
}
struct Popup* luaX_checkPopup(lua_State *L, int idx) {
	return GetPopup(luaX_checkObject(L, idx));
}
#define ID_Screen 0x9bd8c631
REGISTER_CLASS(Popup, ID_Screen, 0);
...
ORCA_API int luaopen_orca_UIKit(lua_State *L) {
	...
	REGISTER_MESSAGE_TYPE(ID_TextBlockConcept_MakeText, "TextBlockConcept.MakeText", TextBlockConcept_MakeTextEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_DrawBrush, "Node2D.DrawBrush", Node2D_DrawBrushEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_Measure, "Node2D.Measure", Node2D_MeasureEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_Arrange, "Node2D.Arrange", Node2D_ArrangeEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_MeasureOverride, "Node2D.MeasureOverride", Node2D_MeasureOverrideEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_ArrangeOverride, "Node2D.ArrangeOverride", Node2D_ArrangeOverrideEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_ForegroundContent, "Node2D.ForegroundContent", Node2D_ForegroundContentEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_UpdateGeometry, "Node2D.UpdateGeometry", Node2D_UpdateGeometryEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Node2D_SetScrollTop, "Node2D.SetScrollTop", Node2D_SetScrollTopEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Button_Click, "Button.Click", Button_ClickEventArgs);
	REGISTER_MESSAGE_TYPE(ID_Form_Submit, "Form.Submit", Form_SubmitEventArgs);
	REGISTER_MESSAGE_TYPE(ID_RadioGroup_SelectionChanged, "RadioGroup.SelectionChanged", RadioGroup_SelectionChangedEventArgs);
	REGISTER_MESSAGE_TYPE(ID_TabBar_SelectionChanged, "TabBar.SelectionChanged", TabBar_SelectionChangedEventArgs);
	...
	REGISTER_MESSAGE_TYPE(ID_ConsoleView_Invalidate, "ConsoleView.Invalidate", ConsoleView_InvalidateEventArgs);
	REGISTER_MESSAGE_TYPE(ID_ConsoleView_Unpack, "ConsoleView.Unpack", ConsoleView_UnpackEventArgs);
	REGISTER_MESSAGE_TYPE(ID_ConsoleView_GetIndexPosition, "ConsoleView.GetIndexPosition", ConsoleView_GetIndexPositionEventArgs);
	REGISTER_MESSAGE_TYPE(ID_PageHost_NavigateToPage, "PageHost.NavigateToPage", PageHost_NavigateToPageEventArgs);
	REGISTER_MESSAGE_TYPE(ID_PageHost_NavigateBack, "PageHost.NavigateBack", PageHost_NavigateBackEventArgs);
	...
	lua_setfield(L, ((void)lua_pushclass(L, &_Popup), -2), "Popup");
