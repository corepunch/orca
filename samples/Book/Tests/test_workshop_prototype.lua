...
assert(view.camera == "WorkshopEstablishing")
assert(view.image:find("Rooms/render/workshop/WorkshopEstablishing.jpg", 1, true))
assert(has(view.text, "Grandfather Tolliver"))
assert(subject(view, "KEY-HOOK").kind == "focus", "hook opens a focus")
assert(subject(view, "WORKBENCH").kind == "focus" and subject(view, "WORKBENCH").node == "main_bench")
...
assert(view.camera == "EmptyHookReveal")
...
assert(view.kind == "beat" and view.continue and view.camera == "OilCanCloseup")
...
assert(view.kind == "focus" and view.camera == "LoftLadderCloseup")
local lubricate = assert(labelled(view, "Lubricate the rusty mechanism"))
view = session:choose(lubricate)
assert(view.kind == "beat" and view.camera == "LoftLadderCloseup")
...
assert(view.kind == "beat" and view.camera == "ClimbWorkbenchAction")
...
assert(view.camera == "WorkbenchTopEstablishing")
...
assert(view.kind == "beat" and view.camera == "RepairBookCloseup")
...
assert(view.camera == "ToolBenchEstablishing" and subject(view, "BERTRAND").node == "counter_chair")
...
assert(view.kind == "beat" and view.camera == "WindBertrandAction")
...
assert(view.kind == "beat" and view.camera == "MakeshiftClimbAction")
view = session:continue()
